...
export class HubConnection {
    ...
    constructor(private window: SignalrWindow, private channelConfig: ChannelConfig, private hubName: string, listeners: { [name: string]: (data: any) => void }) {
...
export class ChannelService {
    ...
    public createHub(hubName: string, listeners: { [name: string]: (data: any) => void }): HubConnection {
        return new HubConnection(this.window, this.channelConfig, hubName, listeners);
    }
    ...
    //    //  channel
    //    //
    //    let channelSub = _.find(this.subjects, (x: ChannelSubject) => {
